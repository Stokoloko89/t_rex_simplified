-- Vehicle Database Creation and Population Script
-- Creates a comprehensive vehicle inventory database with 300+ vehicles

-- Create vehicles table if not exists
CREATE TABLE IF NOT EXISTS vehicles (
    id BIGSERIAL PRIMARY KEY,
    mkt VARCHAR(10) NOT NULL DEFAULT 'MCV',
...
CREATE INDEX IF NOT EXISTS idx_vehicles_stock_id ON vehicles(used_vehicle_stock_id);
...
-- Insert 300+ vehicles with diverse South African vehicle inventory
