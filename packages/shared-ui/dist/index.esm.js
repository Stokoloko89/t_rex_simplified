...
import { Button as Button$1, Box, Stepper, Step, StepLabel, Typography, keyframes, Alert, AlertTitle } from '@mui/material';
...
var Button = function (_a) {
    ...
    return (jsx(Button$1, __assign({}, props, { disabled: disabled || loading, sx: __spreadArray([
...
var StepperComponent = function (_a) {
    ...
    return (jsx(Box, { sx: { width: '100%', mb: 3 }, children: jsx(Stepper, { activeStep: activeStep, orientation: orientation, children: steps.map(function (label, index) { return (jsx(Step, { children: jsx(StepLabel, { children: jsx(Typography, { variant: "body2", children: label }) }) }, label)); }) }) }));
};
...
var LoadingSpinner = function (_a) {
    ...
    return (jsxs(Box, { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", p: 3, children: [jsx(Box, { sx: {
                    width: size,
                    height: size,
                    borderRadius: '50%',
                ...
                } }), message && (jsx(Typography, { variant: "body2", sx: {
                    mt: 2,
...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    ErrorBoundary.prototype.render = function () {
        ...
        if (this.state.hasError) {
            ...
            return (jsx(Box, { p: 3, children: jsxs(Alert, { severity: "error", children: [jsx(AlertTitle, { children: "Something went wrong" }), ((_a = this.state.error) === null || _a === void 0 ? void 0 : _a.message) || 'An unexpected error occurred'] }) }));
        }
