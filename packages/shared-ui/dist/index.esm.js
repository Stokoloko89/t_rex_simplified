...
import React__default, { forwardRef, useContext, Children, isValidElement, cloneElement, Component } from 'react';
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return /*#__PURE__*/jsx$1(SvgIcon$1, {
...
var integerPropType$1 = integerPropType;
...
process.env.NODE_ENV !== "production" ? Paper.propTypes /* remove-proptypes */ = {
   ...
   * @default 1
   */
  elevation: chainPropTypes(integerPropType$1, props => {
    const {
      elevation,
      variant
    } = props;
...
const ButtonBase = /*#__PURE__*/React.forwardRef(function ButtonBase(inProps, ref) {
  ...
  return /*#__PURE__*/jsxs(ButtonBaseRoot, {
    ...
    ...buttonProps,
    ...other,
    children: [children, enableTouchRipple ? /*#__PURE__*/jsx$1(TouchRipple$1, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
const IconButton = /*#__PURE__*/React.forwardRef(function IconButton(inProps, ref) {
  ...
  const loadingIndicator = loadingIndicatorProp ?? /*#__PURE__*/jsx$1(CircularProgress$1, {
...
const AlertTitle = /*#__PURE__*/React.forwardRef(function AlertTitle(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(AlertTitleRoot, {
    gutterBottom: true,
    component: "div",
    ownerState: ownerState,
    ref: ref,
...
const Step = /*#__PURE__*/React.forwardRef(function Step(inProps, ref) {
  ...
  const newChildren = /*#__PURE__*/jsxs(StepRoot, {
    as: component,
    className: clsx(classes.root, className),
    ref: ref,
    ownerState: ownerState,
  ...
  return /*#__PURE__*/jsx$1(StepContext$1.Provider, {
    value: contextValue,
...
var CheckCircle = createSvgIcon(/*#__PURE__*/jsx$1("path", {
  d: "M12 0a12 12 0 1 0 0 24 12 12 0 0 0 0-24zm-2 17l-5-5 1.4-1.4 3.6 3.6 7.6-7.6L19 8l-9 9z"
}), 'CheckCircle');

var Warning = createSvgIcon(/*#__PURE__*/jsx$1("path", {
...
const StepIcon = /*#__PURE__*/React.forwardRef(function StepIcon(inProps, ref) {
  ...
  if (typeof icon === 'number' || typeof icon === 'string') {
    ...
    if (error) {
      return /*#__PURE__*/jsx$1(StepIconRoot, {
        as: Warning,
        className: className,
        ref: ref,
        ownerState: ownerState,
    ...
    return /*#__PURE__*/jsxs(StepIconRoot, {
      className: className,
      ref: ref,
      ownerState: ownerState,
      ...other,
      children: [_circle || (_circle = /*#__PURE__*/jsx$1("circle", {
        cx: "12",
        cy: "12",
        r: "12"
      })), /*#__PURE__*/jsx$1(StepIconText, {
...
const StepLabel = /*#__PURE__*/React.forwardRef(function StepLabel(inProps, ref) {
  ...
  const {
    ...
    completed,
    icon: iconContext
  } = React.useContext(StepContext$1);
  ...
  return /*#__PURE__*/jsxs(RootSlot, {
    ...rootProps,
    children: [icon || StepIconSlot ? /*#__PURE__*/jsx$1(StepLabelIconContainer, {
      className: classes.iconContainer,
      ownerState: ownerState,
      children: /*#__PURE__*/jsx$1(StepIconSlot, {
        completed: completed,
        active: active,
        error: error,
        icon: icon,
      ...
      ownerState: ownerState,
      children: [children ? /*#__PURE__*/jsx$1(LabelSlot, {
        ...labelProps,
...
const StepConnector = /*#__PURE__*/React.forwardRef(function StepConnector(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(StepConnectorRoot, {
    className: clsx(classes.root, className),
    ref: ref,
    ownerState: ownerState,
    ...other,
    children: /*#__PURE__*/jsx$1(StepConnectorLine, {
...
const defaultConnector = /*#__PURE__*/jsx$1(StepConnector$1, {});
const Stepper = /*#__PURE__*/React.forwardRef(function Stepper(inProps, ref) {
  ...
  return /*#__PURE__*/jsx$1(StepperContext$1.Provider, {
    value: contextValue,
    children: /*#__PURE__*/jsx$1(StepperRoot, {
      as: component,
      ownerState: ownerState,
      className: clsx(classes.root, className),
      ref: ref,
...
var Button = function (_a) {
    ...
    return (jsx$1(MuiButton, __assign({}, props, { disabled: disabled || loading, sx: __spreadArray([
...
var StepperComponent = function (_a) {
    ...
    return (jsx$1(Box$1, { sx: { width: '100%', mb: 3 }, children: jsx$1(Stepper$1, { activeStep: activeStep, orientation: orientation, children: steps.map(function (label, index) { return (jsx$1(Step$1, { children: jsx$1(StepLabel$1, { children: jsx$1(Typography$1, { variant: "body2", children: label }) }) }, label)); }) }) }));
};

var gradientAnimation = keyframes(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  0% {\n    background-position: 0% 50%;\n  }\n  50% {\n    background-position: 100% 50%;\n  }\n  100% {\n    background-position: 0% 50%;\n  }\n"], ["\n  0% {\n    background-position: 0% 50%;\n  }\n  50% {\n    background-position: 100% 50%;\n  }\n  100% {\n    background-position: 0% 50%;\n  }\n"])));
...
var LoadingSpinner = function (_a) {
    ...
    return (jsxs(Box$1, { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", p: 3, children: [jsx$1(Box$1, { sx: {
                    width: size,
                    height: size,
                    borderRadius: '50%',
                ...
                } }), message && (jsx$1(Typography$1, { variant: "body2", sx: {
                    mt: 2,
...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    ErrorBoundary.prototype.render = function () {
        ...
        if (this.state.hasError) {
            ...
            return (jsx$1(Box$1, { p: 3, children: jsxs(Alert$1, { severity: "error", children: [jsx$1(AlertTitle$1, { children: "Something went wrong" }), ((_a = this.state.error) === null || _a === void 0 ? void 0 : _a.message) || 'An unexpected error occurred'] }) }));
        }
...
export { Button, ErrorBoundary, FALLBACK_VEHICLE_IMAGES, LoadingSpinner, StepperComponent, enrichVehicleWithImages, enrichVehiclesWithImages, formatCurrency, formatCurrencyDetailed, formatDate, formatDateShort, formatDistance, formatEngineSize, formatFuelConsumption, formatNumber, formatPercentage, formatPhoneNumber, formatPower, formatSpeed, formatTorque, formatWeight, getVehicleImages, getVehicleMainImage, hpToKw, kmToMiles, kwToHp, litersPer100kmToMpg, localization, majorCities, milesToKm, mpgToLitersPer100km, southAfricanProvinces, tRexTheme as theme, validateSARegistration };
